...
namespace ConsoleLocaVeiculos.Migrations
{
    ...
    [Migration("20240421053032_LocaVeiculoMig")]
    partial class LocaVeiculoMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleLocaVeiculos.Cliente", b =>
                {
            ...
            modelBuilder.Entity("ConsoleLocaVeiculos.Reserva", b =>
                {
            ...
            modelBuilder.Entity("ConsoleLocaVeiculos.Veiculo", b =>
                {
                    b.Property<int>("IDVeiculo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleLocaVeiculos.Reserva", b =>
                {
                    b.HasOne("ConsoleLocaVeiculos.Cliente", null)
                        .WithMany("Reservas")
                        .HasForeignKey("ClienteIdCliente");

                    b.HasOne("ConsoleLocaVeiculos.Veiculo", null)
                        .WithMany("Reservas")
